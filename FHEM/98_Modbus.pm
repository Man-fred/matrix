##############################################################################
# $Id: 98_Modbus.pm 24146 2021-04-04 10:30:25Z StefanStrobel $
...
sub DefineFn {
    ...
    #if ($dev =~ /.*\,.*/) {             # Modbus Seriell, "," nie in TCP-Adresse
    #    delete $ioHash->{TCPConn};
    #    $ioHash->{SerialConn} = 1;
    #} 
    #else {
...
sub OpenCB {
    ...
    if ($msg) {
        ...
        Log3 $name, 5, "$name: Open callback: ok";
    }
